...
/* Ejercicio 7: cual es el producto más caro (precio_unitario) de cada país */

/* Ejercicio 8: importe total de ventas Online en cada país considerando solo los paises con 
al menos 5 clientes */ 

/* Ejercicio 9: importe_venta medio de la zona donde se encuentre el cliente con la venta con el importe_coste
más alto  */
