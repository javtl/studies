...
def contar_digitos_por_linea():
  
    total_lineas_completas = 0
    digitos_en_linea_actual = 0
    titulo_ingresado = "" 
    
    
    while titulo_ingresado != "*":
        
        titulo_ingresado = input("Libro: ")
        ...
        if titulo_ingresado == "*":
        ...
        elif titulo_ingresado == "/":
            total_lineas_completas += 1
            print(f"Línea completa. Aparecen {digitos_en_linea_actual} dígitos numéricos.")
            ...
            for caracter in titulo_ingresado:
