...
n_payasos = int(input("Ingrese el numero de payasos en el pedido: "))
n_munecas = int(input("Ingrese el numero de muñecas en el pedido: "))

total_peso = (n_payasos*peso_payaso) + (n_munecas*peso_muneca)

print(f"El total del peso del pedido es: {total_peso}")
