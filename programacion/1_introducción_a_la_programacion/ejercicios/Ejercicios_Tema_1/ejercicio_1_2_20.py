...
el prefijo es el código del país +34, y la extensión tiene dos dígitos (por ejemplo +34-
...
telefono = ("Ingrese su telefono con el siguiente formato:[ +00 000000000-00 ]:")
print